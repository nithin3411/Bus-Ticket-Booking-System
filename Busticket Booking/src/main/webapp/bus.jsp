...
%>
<% 
PreparedStatement ps=con.prepareStatement("insert into bus (b_id,b_name,scdl_srcarr,scdl_destarr,dep_date,no_of_seat,r_id,date_,time_)values(?,?,?,?,?,?,?,CURRENT_DATE(),CURRENT_TIME())");
