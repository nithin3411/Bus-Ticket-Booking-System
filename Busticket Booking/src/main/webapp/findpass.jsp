...
<%CallableStatement st=con.prepareCall(" select t_id,p.b_id ,b.b_name,p_name,gender,src,scdl_srcarr,distination,scdl_destarr,dep_date,seat_no,t.tik_price,p.time_,p.date_ from passenger p,ticket t,bus b,route r where p.b_id=t.b_id and p.b_id=b.b_id and r.r_id=b.r_id and uname = ?");
